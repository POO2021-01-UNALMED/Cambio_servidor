        ...
        <div class="row">
            ...
            <!-- Aqui está el formulario de las carpetas -->
                        ...
                        <div class="form-group">
                            <input  class="form-control" type="text" placeholder="Ruta">
                        </div>
                        <div class="form-group">
                            <input  class="form-control" type="text" placeholder="Ingresé nombre">
                        </div>
                        <div class="form-group">
            ...
            <div class="col-md-7">
                ...
                <form>
                    <div class="row">
                        ...
                        <div class="col">
                            <button type="submit" class="btn btn-outline-primary btn-block">Aplicar</button>
                        </div>
                    </div>
                </form>
            </div>
